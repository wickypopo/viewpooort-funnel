...
export function CollaborationBenefitsSection() {
  const section = siteData.collaborationBenefits

  return (
    <SectionBand data-section="collaboration-benefits" id="collaboration-benefits">
